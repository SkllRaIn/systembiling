...
const navItems = [
  { to: '/ads', label: '📊 Дашборд', end: true },
  { to: '/ads/campaigns', label: '🚀 Кампании' },
  { to: '/ads/deposit', label: '💳 Пополнение баланса' },
]
    ...
    <div className="min-h-screen flex bg-gray-50">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-1">Рекламный кабинет</p>
        </div>
